...
class $UsersTable extends Users with TableInfo<$UsersTable, User> {
  ...
  late final GeneratedColumn<String> username =
      GeneratedColumn<String>('username', aliasedName, false, type: DriftSqlType.string, requiredDuringInsert: true);
...
class $FragmentsTable extends Fragments with TableInfo<$FragmentsTable, Fragment> {
  ...
  late final GeneratedColumn<String> fatherFragmentId =
      GeneratedColumn<String>('father_fragment_id', aliasedName, true, type: DriftSqlType.string, requiredDuringInsert: false);
...
class FragmentGroup extends DataClass implements Insertable<FragmentGroup> {
  ...
  FragmentGroup copyWith(
          {String? id, DateTime? createdAt, DateTime? updatedAt, Value<String?> fatherFragmentGroupId = const Value.absent(), String? title}) =>
      FragmentGroup(
        id: id ?? this.id,
        createdAt: createdAt ?? this.createdAt,
        updatedAt: updatedAt ?? this.updatedAt,
...
class MemoryGroup extends DataClass implements Insertable<MemoryGroup> {
  ...
  int get hashCode => Object.hash(
      id, createdAt, updatedAt, memoryModelId, title, type, status, newLearnCount, reviewInterval, filterOut, newReviewDisplayOrder, newDisplayOrder);
...
class $MemoryGroupsTable extends MemoryGroups with TableInfo<$MemoryGroupsTable, MemoryGroup> {
  ...
  late final GeneratedColumn<String> memoryModelId =
      GeneratedColumn<String>('memory_model_id', aliasedName, true, type: DriftSqlType.string, requiredDuringInsert: false);
  final VerificationMeta _titleMeta = const VerificationMeta('title');
  @override
  late final GeneratedColumn<String> title =
      GeneratedColumn<String>('title', aliasedName, false, type: DriftSqlType.string, requiredDuringInsert: true);
  ...
  late final GeneratedColumnWithTypeConverter<MemoryGroupStatus, int> status =
      GeneratedColumn<int>('status', aliasedName, false, type: DriftSqlType.int, requiredDuringInsert: true)
          .withConverter<MemoryGroupStatus>($MemoryGroupsTable.$converter1);
  final VerificationMeta _newLearnCountMeta = const VerificationMeta('newLearnCount');
  @override
  late final GeneratedColumn<int> newLearnCount =
      GeneratedColumn<int>('new_learn_count', aliasedName, false, type: DriftSqlType.int, requiredDuringInsert: true);
  ...
  late final GeneratedColumn<DateTime> reviewInterval =
      GeneratedColumn<DateTime>('review_interval', aliasedName, false, type: DriftSqlType.dateTime, requiredDuringInsert: true);
  final VerificationMeta _filterOutMeta = const VerificationMeta('filterOut');
  @override
  late final GeneratedColumn<String> filterOut =
      GeneratedColumn<String>('filter_out', aliasedName, false, type: DriftSqlType.string, requiredDuringInsert: true);
  ...
  VerificationContext validateIntegrity(Insertable<MemoryGroup> instance, {bool isInserting = false}) {
    ...
    if (data.containsKey('new_learn_count')) {
      context.handle(_newLearnCountMeta, newLearnCount.isAcceptableOrUnknown(data['new_learn_count']!, _newLearnCountMeta));
    } else if (isInserting) {
  ...
  MemoryGroup map(Map<String, dynamic> data, {String? tablePrefix}) {
    ...
    return MemoryGroup(
      ...
      status: $MemoryGroupsTable.$converter1.fromSql(attachedDatabase.options.types.read(DriftSqlType.int, data['${effectivePrefix}status'])!),
      newLearnCount: attachedDatabase.options.types.read(DriftSqlType.int, data['${effectivePrefix}new_learn_count'])!,
      ...
      newReviewDisplayOrder: $MemoryGroupsTable.$converter2
          .fromSql(attachedDatabase.options.types.read(DriftSqlType.int, data['${effectivePrefix}new_review_display_order'])!),
      newDisplayOrder:
          $MemoryGroupsTable.$converter3.fromSql(attachedDatabase.options.types.read(DriftSqlType.int, data['${effectivePrefix}new_display_order'])!),
    );
  }
  ...
  static TypeConverter<MemoryGroupStatus, int> $converter1 = const EnumIndexConverter<MemoryGroupStatus>(MemoryGroupStatus.values);
  static TypeConverter<NewReviewDisplayOrder, int> $converter2 = const EnumIndexConverter<NewReviewDisplayOrder>(NewReviewDisplayOrder.values);
  static TypeConverter<NewDisplayOrder, int> $converter3 = const EnumIndexConverter<NewDisplayOrder>(NewDisplayOrder.values);
}
...
class MemoryModel extends DataClass implements Insertable<MemoryModel> {
  ...
  @override
  int get hashCode => Object.hash(id, createdAt, updatedAt, title, familiarityAlgorithm, nextTimeAlgorithm, buttonData);
...
class $MemoryModelsTable extends MemoryModels with TableInfo<$MemoryModelsTable, MemoryModel> {
  ...
  late final GeneratedColumn<String> nextTimeAlgorithm =
      GeneratedColumn<String>('next_time_algorithm', aliasedName, false, type: DriftSqlType.string, requiredDuringInsert: true);
  final VerificationMeta _buttonDataMeta = const VerificationMeta('buttonData');
  @override
  late final GeneratedColumn<String> buttonData =
      GeneratedColumn<String>('button_data', aliasedName, false, type: DriftSqlType.string, requiredDuringInsert: true);

  @override
  List<GeneratedColumn> get $columns => [id, createdAt, updatedAt, title, familiarityAlgorithm, nextTimeAlgorithm, buttonData];
  ...
  VerificationContext validateIntegrity(Insertable<MemoryModel> instance, {bool isInserting = false}) {
    ...
    if (data.containsKey('button_data')) {
      context.handle(_buttonDataMeta, buttonData.isAcceptableOrUnknown(data['button_data']!, _buttonDataMeta));
    } else if (isInserting) {
  ...
  MemoryModel map(Map<String, dynamic> data, {String? tablePrefix}) {
    ...
    return MemoryModel(
      ...
      buttonData: attachedDatabase.options.types.read(DriftSqlType.string, data['${effectivePrefix}button_data'])!,
    );
  }
...
class FragmentMemoryInfo extends DataClass implements Insertable<FragmentMemoryInfo> {
  ...
  FragmentMemoryInfosCompanion toCompanion(bool nullToAbsent) {
    return FragmentMemoryInfosCompanion(
      ...
      actualNextShowTime: actualNextShowTime == null && nullToAbsent ? const Value.absent() : Value(actualNextShowTime),
  ...
  factory FragmentMemoryInfo.fromJson(Map<String, dynamic> json, {ValueSerializer? serializer}) {
    ...
    return FragmentMemoryInfo(
      ...
      planedNextShowTime: serializer.fromJson<DateTime>(json['planedNextShowTime']),
      actualNextShowTime: serializer.fromJson<DateTime?>(json['actualNextShowTime']),
  ...
  FragmentMemoryInfo copyWith(
      ...
      FragmentMemoryInfo(
        ...
        actualNextShowTime: actualNextShowTime.present ? actualNextShowTime.value : this.actualNextShowTime,
  ...
  @override
  int get hashCode => Object.hash(id, createdAt, updatedAt, fragmentId, memoryGroupId, stageButtonValue, stageFamiliarity, planedNextShowTime,
      actualNextShowTime, showDuration, isLatestRecord);
...
class FragmentMemoryInfosCompanion extends UpdateCompanion<FragmentMemoryInfo> {
  ...
  static Insertable<FragmentMemoryInfo> custom({
    ...
    return RawValuesInsertable({
      ...
      if (planedNextShowTime != null) 'planed_next_show_time': planedNextShowTime,
      if (actualNextShowTime != null) 'actual_next_show_time': actualNextShowTime,
  ...
  Map<String, Expression> toColumns(bool nullToAbsent) {
    ...
    if (planedNextShowTime.present) {
      map['planed_next_show_time'] = Variable<DateTime>(planedNextShowTime.value);
    }
    if (actualNextShowTime.present) {
      map['actual_next_show_time'] = Variable<DateTime>(actualNextShowTime.value);
    }
...
class $FragmentMemoryInfosTable extends FragmentMemoryInfos with TableInfo<$FragmentMemoryInfosTable, FragmentMemoryInfo> {
  ...
  late final GeneratedColumn<String> fragmentId =
      GeneratedColumn<String>('fragment_id', aliasedName, false, type: DriftSqlType.string, requiredDuringInsert: true);
  ...
  late final GeneratedColumn<String> memoryGroupId =
      GeneratedColumn<String>('memory_group_id', aliasedName, false, type: DriftSqlType.string, requiredDuringInsert: true);
  ...
  late final GeneratedColumn<double> stageButtonValue =
      GeneratedColumn<double>('stage_button_value', aliasedName, false, type: DriftSqlType.double, requiredDuringInsert: true);
  ...
  late final GeneratedColumn<double> stageFamiliarity =
      GeneratedColumn<double>('stage_familiarity', aliasedName, false, type: DriftSqlType.double, requiredDuringInsert: true);
  final VerificationMeta _planedNextShowTimeMeta = const VerificationMeta('planedNextShowTime');
  @override
  late final GeneratedColumn<DateTime> planedNextShowTime =
      GeneratedColumn<DateTime>('planed_next_show_time', aliasedName, false, type: DriftSqlType.dateTime, requiredDuringInsert: true);
  final VerificationMeta _actualNextShowTimeMeta = const VerificationMeta('actualNextShowTime');
  @override
  late final GeneratedColumn<DateTime> actualNextShowTime =
      GeneratedColumn<DateTime>('actual_next_show_time', aliasedName, true, type: DriftSqlType.dateTime, requiredDuringInsert: false);
  final VerificationMeta _showDurationMeta = const VerificationMeta('showDuration');
  @override
  late final GeneratedColumn<double> showDuration =
      GeneratedColumn<double>('show_duration', aliasedName, false, type: DriftSqlType.double, requiredDuringInsert: true);
  final VerificationMeta _isLatestRecordMeta = const VerificationMeta('isLatestRecord');
  @override
  late final GeneratedColumn<bool> isLatestRecord = GeneratedColumn<bool>('is_latest_record', aliasedName, false,
      type: DriftSqlType.bool, requiredDuringInsert: true, defaultConstraints: 'CHECK (is_latest_record IN (0, 1))');
  ...
  VerificationContext validateIntegrity(Insertable<FragmentMemoryInfo> instance, {bool isInserting = false}) {
    ...
    if (data.containsKey('planed_next_show_time')) {
      context.handle(_planedNextShowTimeMeta, planedNextShowTime.isAcceptableOrUnknown(data['planed_next_show_time']!, _planedNextShowTimeMeta));
    } else if (isInserting) {
      context.missing(_planedNextShowTimeMeta);
    }
    if (data.containsKey('actual_next_show_time')) {
      context.handle(_actualNextShowTimeMeta, actualNextShowTime.isAcceptableOrUnknown(data['actual_next_show_time']!, _actualNextShowTimeMeta));
    }
  ...
  FragmentMemoryInfo map(Map<String, dynamic> data, {String? tablePrefix}) {
    ...
    return FragmentMemoryInfo(
      ...
      stageButtonValue: attachedDatabase.options.types.read(DriftSqlType.double, data['${effectivePrefix}stage_button_value'])!,
      stageFamiliarity: attachedDatabase.options.types.read(DriftSqlType.double, data['${effectivePrefix}stage_familiarity'])!,
      planedNextShowTime: attachedDatabase.options.types.read(DriftSqlType.dateTime, data['${effectivePrefix}planed_next_show_time'])!,
      actualNextShowTime: attachedDatabase.options.types.read(DriftSqlType.dateTime, data['${effectivePrefix}actual_next_show_time']),
      showDuration: attachedDatabase.options.types.read(DriftSqlType.double, data['${effectivePrefix}show_duration'])!,
...
class RFragment2FragmentGroup extends DataClass implements Insertable<RFragment2FragmentGroup> {
  ...
  RFragment2FragmentGroup copyWith(
          {Value<String?> fatherId = const Value.absent(), String? sonId, String? id, DateTime? createdAt, DateTime? updatedAt}) =>
...
class $RFragment2FragmentGroupsTable extends RFragment2FragmentGroups with TableInfo<$RFragment2FragmentGroupsTable, RFragment2FragmentGroup> {
  ...
  late final GeneratedColumn<String> fatherId =
      GeneratedColumn<String>('father_id', aliasedName, true, type: DriftSqlType.string, requiredDuringInsert: false);
  final VerificationMeta _sonIdMeta = const VerificationMeta('sonId');
  @override
  late final GeneratedColumn<String> sonId =
      GeneratedColumn<String>('son_id', aliasedName, false, type: DriftSqlType.string, requiredDuringInsert: true);
  final VerificationMeta _idMeta = const VerificationMeta('id');
  @override
  late final GeneratedColumn<String> id = GeneratedColumn<String>('id', aliasedName, false, type: DriftSqlType.string, requiredDuringInsert: true);
  final VerificationMeta _createdAtMeta = const VerificationMeta('createdAt');
...
class $AppInfosTable extends AppInfos with TableInfo<$AppInfosTable, AppInfo> {
  ...
  late final GeneratedColumn<String> token = GeneratedColumn<String>('token', aliasedName, false,
      type: DriftSqlType.string, requiredDuringInsert: false, defaultValue: const Constant('unknown'));
...
class $SyncsTable extends Syncs with TableInfo<$SyncsTable, Sync> {
  ...
  late final GeneratedColumn<String> syncTableName =
      GeneratedColumn<String>('sync_table_name', aliasedName, false, type: DriftSqlType.string, requiredDuringInsert: true);
  final VerificationMeta _rowIdMeta = const VerificationMeta('rowId');
  @override
  late final GeneratedColumn<String> rowId =
      GeneratedColumn<String>('row_id', aliasedName, false, type: DriftSqlType.string, requiredDuringInsert: true);
  ...
  late final GeneratedColumnWithTypeConverter<SyncCurdType?, int> syncCurdType =
      GeneratedColumn<int>('sync_curd_type', aliasedName, true, type: DriftSqlType.int, requiredDuringInsert: false)
