...
//                 return Text('builder 1: ' + controller.number.get(abw).toString());
//               },
//             ),
//             AbBuilder<DemoController>(
//               builder: (controller, abw) {
//                 return Text('builder 2: ' + controller.number.get(abw).toString());
//               },
//             ),
//             TextButton(
...
//             AbBuilder<DemoController>(
//               builder: (controller, abw) {
//                 return Text('builder 3: ' + controller.number.get(abw).toString());
//               },
//             ),
//             TextButton(
//               child: const Text('increase'),
