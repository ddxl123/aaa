...
class User extends DataClass implements Insertable<User> {
  ...
  factory User.fromData(Map<String, dynamic> data, {String? prefix}) {
    ...
    return User(
      ...
      username: const StringType().mapFromDatabaseResponse(data['${effectivePrefix}username'])!,
      ...
      age: const IntType().mapFromDatabaseResponse(data['${effectivePrefix}age'])!,
    );
  }
...
class $UsersTable extends Users with TableInfo<$UsersTable, User> {
  ...
  late final GeneratedColumn<String?> username = GeneratedColumn<String?>('username', aliasedName, false,
      type: const StringType(), requiredDuringInsert: false, defaultValue: const Constant('还没有名字'));
  final VerificationMeta _passwordMeta = const VerificationMeta('password');
  @override
  late final GeneratedColumn<String?> password =
      GeneratedColumn<String?>('password', aliasedName, true, type: const StringType(), requiredDuringInsert: false);
  final VerificationMeta _emailMeta = const VerificationMeta('email');
  @override
  late final GeneratedColumn<String?> email =
      GeneratedColumn<String?>('email', aliasedName, false, type: const StringType(), requiredDuringInsert: false, defaultValue: const Constant('-'));
  final VerificationMeta _ageMeta = const VerificationMeta('age');
  @override
  late final GeneratedColumn<int?> age = GeneratedColumn<int?>('age', aliasedName, false,
      check: () => age.isBiggerOrEqual(const Constant(0)), type: const IntType(), requiredDuringInsert: false, defaultValue: const Constant(0));
  ...
  User map(Map<String, dynamic> data, {String? tablePrefix}) {
    return User.fromData(data, prefix: tablePrefix != null ? '$tablePrefix.' : null);
  }
...
class Fragment extends DataClass implements Insertable<Fragment> {
  ...
  factory Fragment.fromData(Map<String, dynamic> data, {String? prefix}) {
    ...
    return Fragment(
      ...
      createdAt: const DateTimeType().mapFromDatabaseResponse(data['${effectivePrefix}created_at'])!,
      updatedAt: const DateTimeType().mapFromDatabaseResponse(data['${effectivePrefix}updated_at'])!,
      fatherFragmentId: const StringType().mapFromDatabaseResponse(data['${effectivePrefix}father_fragment_id']),
      title: const StringType().mapFromDatabaseResponse(data['${effectivePrefix}title'])!,
      priority: const IntType().mapFromDatabaseResponse(data['${effectivePrefix}priority'])!,
    );
  }
  ...
  Fragment copyWith({String? id, DateTime? createdAt, DateTime? updatedAt, String? fatherFragmentId, String? title, int? priority}) => Fragment(
        id: id ?? this.id,
        createdAt: createdAt ?? this.createdAt,
        updatedAt: updatedAt ?? this.updatedAt,
...
class $FragmentsTable extends Fragments with TableInfo<$FragmentsTable, Fragment> {
  ...
  late final GeneratedColumn<String?> fatherFragmentId =
      GeneratedColumn<String?>('father_fragment_id', aliasedName, true, type: const StringType(), requiredDuringInsert: false);
  final VerificationMeta _titleMeta = const VerificationMeta('title');
  @override
  late final GeneratedColumn<String?> title = GeneratedColumn<String?>('title', aliasedName, false,
      type: const StringType(), requiredDuringInsert: false, defaultValue: const Constant('还没有标题'));
  final VerificationMeta _priorityMeta = const VerificationMeta('priority');
  @override
  late final GeneratedColumn<int?> priority = GeneratedColumn<int?>('priority', aliasedName, false,
      check: () => priority.isBiggerOrEqual(const Constant(0)), type: const IntType(), requiredDuringInsert: false, defaultValue: const Constant(0));
  ...
  Fragment map(Map<String, dynamic> data, {String? tablePrefix}) {
    return Fragment.fromData(data, prefix: tablePrefix != null ? '$tablePrefix.' : null);
  }
...
class FragmentGroup extends DataClass implements Insertable<FragmentGroup> {
  ...
  factory FragmentGroup.fromData(Map<String, dynamic> data, {String? prefix}) {
    ...
    return FragmentGroup(
      ...
      createdAt: const DateTimeType().mapFromDatabaseResponse(data['${effectivePrefix}created_at'])!,
      updatedAt: const DateTimeType().mapFromDatabaseResponse(data['${effectivePrefix}updated_at'])!,
      fatherFragmentGroupId: const StringType().mapFromDatabaseResponse(data['${effectivePrefix}father_fragment_group_id']),
      title: const StringType().mapFromDatabaseResponse(data['${effectivePrefix}title'])!,
    );
  }
  ...
  FragmentGroup copyWith({String? id, DateTime? createdAt, DateTime? updatedAt, String? fatherFragmentGroupId, String? title}) => FragmentGroup(
        id: id ?? this.id,
        createdAt: createdAt ?? this.createdAt,
        updatedAt: updatedAt ?? this.updatedAt,
...
class FragmentGroupsCompanion extends UpdateCompanion<FragmentGroup> {
  ...
  FragmentGroupsCompanion copyWith(
      {Value<String>? id, Value<DateTime>? createdAt, Value<DateTime>? updatedAt, Value<String?>? fatherFragmentGroupId, Value<String>? title}) {
    return FragmentGroupsCompanion(
      id: id ?? this.id,
      createdAt: createdAt ?? this.createdAt,
      updatedAt: updatedAt ?? this.updatedAt,
...
class $FragmentGroupsTable extends FragmentGroups with TableInfo<$FragmentGroupsTable, FragmentGroup> {
  ...
  late final GeneratedColumn<String?> fatherFragmentGroupId =
      GeneratedColumn<String?>('father_fragment_group_id', aliasedName, true, type: const StringType(), requiredDuringInsert: false);
  final VerificationMeta _titleMeta = const VerificationMeta('title');
  @override
  late final GeneratedColumn<String?> title = GeneratedColumn<String?>('title', aliasedName, false,
      type: const StringType(), requiredDuringInsert: false, defaultValue: const Constant('还没有名称'));
  ...
  VerificationContext validateIntegrity(Insertable<FragmentGroup> instance, {bool isInserting = false}) {
    ...
    if (data.containsKey('father_fragment_group_id')) {
      context.handle(
          _fatherFragmentGroupIdMeta, fatherFragmentGroupId.isAcceptableOrUnknown(data['father_fragment_group_id']!, _fatherFragmentGroupIdMeta));
    }
    if (data.containsKey('title')) {
      context.handle(_titleMeta, title.isAcceptableOrUnknown(data['title']!, _titleMeta));
    }
  ...
  FragmentGroup map(Map<String, dynamic> data, {String? tablePrefix}) {
    return FragmentGroup.fromData(data, prefix: tablePrefix != null ? '$tablePrefix.' : null);
  }
...
class MemoryGroup extends DataClass implements Insertable<MemoryGroup> {
  ...
  factory MemoryGroup.fromData(Map<String, dynamic> data, {String? prefix}) {
    ...
    return MemoryGroup(
      ...
      updatedAt: const DateTimeType().mapFromDatabaseResponse(data['${effectivePrefix}updated_at'])!,
      title: const StringType().mapFromDatabaseResponse(data['${effectivePrefix}title'])!,
      type: $MemoryGroupsTable.$converter0.mapToDart(const IntType().mapFromDatabaseResponse(data['${effectivePrefix}type']))!,
      normalStatus: $MemoryGroupsTable.$converter1.mapToDart(const IntType().mapFromDatabaseResponse(data['${effectivePrefix}normal_status']))!,
      normalPartStatus:
          $MemoryGroupsTable.$converter2.mapToDart(const IntType().mapFromDatabaseResponse(data['${effectivePrefix}normal_part_status']))!,
      fullFloatingStatus:
          $MemoryGroupsTable.$converter3.mapToDart(const IntType().mapFromDatabaseResponse(data['${effectivePrefix}full_floating_status']))!,
    );
  }
  ...
  Map<String, Expression> toColumns(bool nullToAbsent) {
    ...
    }
    {
      ...
      map['normal_part_status'] = Variable<int>(converter.mapToSql(normalPartStatus)!);
    }
    {
      final converter = $MemoryGroupsTable.$converter3;
      map['full_floating_status'] = Variable<int>(converter.mapToSql(fullFloatingStatus)!);
    }
    return map;
  }
  ...
  factory MemoryGroup.fromJson(Map<String, dynamic> json, {ValueSerializer? serializer}) {
    ...
    return MemoryGroup(
      ...
      normalStatus: serializer.fromJson<MemoryGroupStatusForNormal>(json['normalStatus']),
      normalPartStatus: serializer.fromJson<MemoryGroupStatusForNormalPart>(json['normalPartStatus']),
      fullFloatingStatus: serializer.fromJson<MemoryGroupStatusForFullFloating>(json['fullFloatingStatus']),
    );
  }
  ...
  Map<String, dynamic> toJson({ValueSerializer? serializer}) {
    ...
    return <String, dynamic>{
      ...
      'normalStatus': serializer.toJson<MemoryGroupStatusForNormal>(normalStatus),
      'normalPartStatus': serializer.toJson<MemoryGroupStatusForNormalPart>(normalPartStatus),
      'fullFloatingStatus': serializer.toJson<MemoryGroupStatusForFullFloating>(fullFloatingStatus),
    };
  }
  ...
  @override
  int get hashCode => Object.hash(id, createdAt, updatedAt, title, type, normalStatus, normalPartStatus, fullFloatingStatus);
...
class MemoryGroupsCompanion extends UpdateCompanion<MemoryGroup> {
  ...
  static Insertable<MemoryGroup> custom({
    ...
    return RawValuesInsertable({
      ...
      if (fullFloatingStatus != null) 'full_floating_status': fullFloatingStatus,
    });
  }
  ...
  Map<String, Expression> toColumns(bool nullToAbsent) {
    ...
    if (normalStatus.present) {
      final converter = $MemoryGroupsTable.$converter1;
      map['normal_status'] = Variable<int>(converter.mapToSql(normalStatus.value)!);
    }
    if (normalPartStatus.present) {
      final converter = $MemoryGroupsTable.$converter2;
      map['normal_part_status'] = Variable<int>(converter.mapToSql(normalPartStatus.value)!);
    }
    if (fullFloatingStatus.present) {
      final converter = $MemoryGroupsTable.$converter3;
      map['full_floating_status'] = Variable<int>(converter.mapToSql(fullFloatingStatus.value)!);
    }
    return map;
  }
...
class $MemoryGroupsTable extends MemoryGroups with TableInfo<$MemoryGroupsTable, MemoryGroup> {
  ...
  @override
  late final GeneratedColumnWithTypeConverter<MemoryGroupType, int?> type = GeneratedColumn<int?>('type', aliasedName, false,
          type: const IntType(), requiredDuringInsert: false, defaultValue: Constant(MemoryGroupType.inApp.index))
      .withConverter<MemoryGroupType>($MemoryGroupsTable.$converter0);
  final VerificationMeta _normalStatusMeta = const VerificationMeta('normalStatus');
  @override
  late final GeneratedColumnWithTypeConverter<MemoryGroupStatusForNormal, int?> normalStatus = GeneratedColumn<int?>(
          'normal_status', aliasedName, false,
          type: const IntType(), requiredDuringInsert: false, defaultValue: Constant(MemoryGroupStatusForNormal.notStart.index))
      .withConverter<MemoryGroupStatusForNormal>($MemoryGroupsTable.$converter1);
  final VerificationMeta _normalPartStatusMeta = const VerificationMeta('normalPartStatus');
  @override
  late final GeneratedColumnWithTypeConverter<MemoryGroupStatusForNormalPart, int?> normalPartStatus = GeneratedColumn<int?>(
          'normal_part_status', aliasedName, false,
          type: const IntType(), requiredDuringInsert: false, defaultValue: Constant(MemoryGroupStatusForNormalPart.disabled.index))
      .withConverter<MemoryGroupStatusForNormalPart>($MemoryGroupsTable.$converter2);
  final VerificationMeta _fullFloatingStatusMeta = const VerificationMeta('fullFloatingStatus');
  @override
  late final GeneratedColumnWithTypeConverter<MemoryGroupStatusForFullFloating, int?> fullFloatingStatus = GeneratedColumn<int?>(
          'full_floating_status', aliasedName, false,
          type: const IntType(), requiredDuringInsert: false, defaultValue: Constant(MemoryGroupStatusForFullFloating.notStarted.index))
      .withConverter<MemoryGroupStatusForFullFloating>($MemoryGroupsTable.$converter3);

  @override
  List<GeneratedColumn> get $columns => [id, createdAt, updatedAt, title, type, normalStatus, normalPartStatus, fullFloatingStatus];
  ...
  MemoryGroup map(Map<String, dynamic> data, {String? tablePrefix}) {
    return MemoryGroup.fromData(data, prefix: tablePrefix != null ? '$tablePrefix.' : null);
  }
  ...
  static TypeConverter<MemoryGroupStatusForNormal, int> $converter1 =
      const EnumIndexConverter<MemoryGroupStatusForNormal>(MemoryGroupStatusForNormal.values);
  static TypeConverter<MemoryGroupStatusForNormalPart, int> $converter2 =
      const EnumIndexConverter<MemoryGroupStatusForNormalPart>(MemoryGroupStatusForNormalPart.values);
  static TypeConverter<MemoryGroupStatusForFullFloating, int> $converter3 =
      const EnumIndexConverter<MemoryGroupStatusForFullFloating>(MemoryGroupStatusForFullFloating.values);
}
...
class MemoryModel extends DataClass implements Insertable<MemoryModel> {
  ...
  MemoryModel(
      {required this.id, required this.createdAt, required this.updatedAt, required this.title, this.familiarityAlgorithm, this.nextTimeAlgorithm});
  ...
  factory MemoryModel.fromData(Map<String, dynamic> data, {String? prefix}) {
    ...
    return MemoryModel(
      ...
      updatedAt: const DateTimeType().mapFromDatabaseResponse(data['${effectivePrefix}updated_at'])!,
      title: const StringType().mapFromDatabaseResponse(data['${effectivePrefix}title'])!,
      familiarityAlgorithm: const StringType().mapFromDatabaseResponse(data['${effectivePrefix}familiarity_algorithm']),
      nextTimeAlgorithm: const StringType().mapFromDatabaseResponse(data['${effectivePrefix}next_time_algorithm']),
    );
  }
  ...
  MemoryModelsCompanion toCompanion(bool nullToAbsent) {
    return MemoryModelsCompanion(
      ...
      updatedAt: Value(updatedAt),
      title: Value(title),
      familiarityAlgorithm: familiarityAlgorithm == null && nullToAbsent ? const Value.absent() : Value(familiarityAlgorithm),
      nextTimeAlgorithm: nextTimeAlgorithm == null && nullToAbsent ? const Value.absent() : Value(nextTimeAlgorithm),
    );
  }
  ...
  MemoryModel copyWith(
          {String? id, DateTime? createdAt, DateTime? updatedAt, String? title, String? familiarityAlgorithm, String? nextTimeAlgorithm}) =>
      MemoryModel(
        id: id ?? this.id,
        createdAt: createdAt ?? this.createdAt,
        updatedAt: updatedAt ?? this.updatedAt,
  ...
  @override
  int get hashCode => Object.hash(id, createdAt, updatedAt, title, familiarityAlgorithm, nextTimeAlgorithm);
...
class $MemoryModelsTable extends MemoryModels with TableInfo<$MemoryModelsTable, MemoryModel> {
  ...
  late final GeneratedColumn<String?> familiarityAlgorithm =
      GeneratedColumn<String?>('familiarity_algorithm', aliasedName, true, type: const StringType(), requiredDuringInsert: false);
  ...
  late final GeneratedColumn<String?> nextTimeAlgorithm =
      GeneratedColumn<String?>('next_time_algorithm', aliasedName, true, type: const StringType(), requiredDuringInsert: false);

  @override
  List<GeneratedColumn> get $columns => [id, createdAt, updatedAt, title, familiarityAlgorithm, nextTimeAlgorithm];
  ...
  VerificationContext validateIntegrity(Insertable<MemoryModel> instance, {bool isInserting = false}) {
    ...
    if (data.containsKey('familiarity_algorithm')) {
      context.handle(
          _familiarityAlgorithmMeta, familiarityAlgorithm.isAcceptableOrUnknown(data['familiarity_algorithm']!, _familiarityAlgorithmMeta));
    }
  ...
  MemoryModel map(Map<String, dynamic> data, {String? tablePrefix}) {
    return MemoryModel.fromData(data, prefix: tablePrefix != null ? '$tablePrefix.' : null);
  }
...
class FragmentPermanentMemoryInfo extends DataClass implements Insertable<FragmentPermanentMemoryInfo> {
  /// 当子表类为 [Users] 时，
  ///   - 云端创建、云端获取。
  ///   - 无需自增，无需作为主键。
  ///
  ...
  factory FragmentPermanentMemoryInfo.fromData(Map<String, dynamic> data, {String? prefix}) {
    final effectivePrefix = prefix ?? '';
    return FragmentPermanentMemoryInfo(
      id: const StringType().mapFromDatabaseResponse(data['${effectivePrefix}id'])!,
      createdAt: const DateTimeType().mapFromDatabaseResponse(data['${effectivePrefix}created_at'])!,
      updatedAt: const DateTimeType().mapFromDatabaseResponse(data['${effectivePrefix}updated_at'])!,
      fragmentId: const StringType().mapFromDatabaseResponse(data['${effectivePrefix}fragment_id']),
      memoryModelId: const StringType().mapFromDatabaseResponse(data['${effectivePrefix}memory_model_id']),
      memoryGroupId: const StringType().mapFromDatabaseResponse(data['${effectivePrefix}memory_group_id']),
      stageButtonValue: const RealType().mapFromDatabaseResponse(data['${effectivePrefix}stage_button_value']),
      stageFamiliarity: const RealType().mapFromDatabaseResponse(data['${effectivePrefix}stage_familiarity'])!,
      nextShowTime: const DateTimeType().mapFromDatabaseResponse(data['${effectivePrefix}next_show_time']),
      showDuration: const RealType().mapFromDatabaseResponse(data['${effectivePrefix}show_duration'])!,
    );
  }
  ...
  FragmentPermanentMemoryInfosCompanion toCompanion(bool nullToAbsent) {
    return FragmentPermanentMemoryInfosCompanion(
      ...
      createdAt: Value(createdAt),
      updatedAt: Value(updatedAt),
      fragmentId: fragmentId == null && nullToAbsent ? const Value.absent() : Value(fragmentId),
      memoryModelId: memoryModelId == null && nullToAbsent ? const Value.absent() : Value(memoryModelId),
      memoryGroupId: memoryGroupId == null && nullToAbsent ? const Value.absent() : Value(memoryGroupId),
      stageButtonValue: stageButtonValue == null && nullToAbsent ? const Value.absent() : Value(stageButtonValue),
      stageFamiliarity: Value(stageFamiliarity),
      nextShowTime: nextShowTime == null && nullToAbsent ? const Value.absent() : Value(nextShowTime),
      showDuration: Value(showDuration),
    );
  }

  factory FragmentPermanentMemoryInfo.fromJson(Map<String, dynamic> json, {ValueSerializer? serializer}) {
    serializer ??= driftRuntimeOptions.defaultSerializer;
    return FragmentPermanentMemoryInfo(
      id: serializer.fromJson<String>(json['id']),
      createdAt: serializer.fromJson<DateTime>(json['createdAt']),
  ...
  @override
  int get hashCode =>
      Object.hash(id, createdAt, updatedAt, fragmentId, memoryModelId, memoryGroupId, stageButtonValue, stageFamiliarity, nextShowTime, showDuration);
...
class FragmentPermanentMemoryInfosCompanion extends UpdateCompanion<FragmentPermanentMemoryInfo> {
  Value<String> id;
  Value<DateTime> createdAt;
  Value<DateTime> updatedAt;
...
class $FragmentPermanentMemoryInfosTable extends FragmentPermanentMemoryInfos
    with TableInfo<$FragmentPermanentMemoryInfosTable, FragmentPermanentMemoryInfo> {
  @override
  final GeneratedDatabase attachedDatabase;
  final String? _alias;
  ...
  @override
  late final GeneratedColumn<String?> fragmentId =
      GeneratedColumn<String?>('fragment_id', aliasedName, true, type: const StringType(), requiredDuringInsert: false);
  final VerificationMeta _memoryModelIdMeta = const VerificationMeta('memoryModelId');
  @override
  late final GeneratedColumn<String?> memoryModelId =
      GeneratedColumn<String?>('memory_model_id', aliasedName, true, type: const StringType(), requiredDuringInsert: false);
  final VerificationMeta _memoryGroupIdMeta = const VerificationMeta('memoryGroupId');
  @override
  late final GeneratedColumn<String?> memoryGroupId =
      GeneratedColumn<String?>('memory_group_id', aliasedName, true, type: const StringType(), requiredDuringInsert: false);
  final VerificationMeta _stageButtonValueMeta = const VerificationMeta('stageButtonValue');
  @override
  late final GeneratedColumn<double?> stageButtonValue =
      GeneratedColumn<double?>('stage_button_value', aliasedName, true, type: const RealType(), requiredDuringInsert: false);
  final VerificationMeta _stageFamiliarityMeta = const VerificationMeta('stageFamiliarity');
  @override
  late final GeneratedColumn<double?> stageFamiliarity = GeneratedColumn<double?>('stage_familiarity', aliasedName, false,
      check: () => stageFamiliarity.isBetween(const Constant(0), const Constant(1)),
      type: const RealType(),
      requiredDuringInsert: false,
      defaultValue: const Constant(0));
  final VerificationMeta _nextShowTimeMeta = const VerificationMeta('nextShowTime');
  @override
  late final GeneratedColumn<DateTime?> nextShowTime =
      GeneratedColumn<DateTime?>('next_show_time', aliasedName, true, type: const IntType(), requiredDuringInsert: false);
  final VerificationMeta _showDurationMeta = const VerificationMeta('showDuration');
  @override
  late final GeneratedColumn<double?> showDuration = GeneratedColumn<double?>('show_duration', aliasedName, false,
      type: const RealType(), requiredDuringInsert: false, defaultValue: const Constant(0));

  @override
  List<GeneratedColumn> get $columns =>
      [id, createdAt, updatedAt, fragmentId, memoryModelId, memoryGroupId, stageButtonValue, stageFamiliarity, nextShowTime, showDuration];
  ...
  @override
  VerificationContext validateIntegrity(Insertable<FragmentPermanentMemoryInfo> instance, {bool isInserting = false}) {
    final context = VerificationContext();
    final data = instance.toColumns(true);
    if (data.containsKey('id')) {
      context.handle(_idMeta, id.isAcceptableOrUnknown(data['id']!, _idMeta));
    ...
    if (data.containsKey('stage_button_value')) {
      context.handle(_stageButtonValueMeta, stageButtonValue.isAcceptableOrUnknown(data['stage_button_value']!, _stageButtonValueMeta));
    }
    if (data.containsKey('stage_familiarity')) {
      context.handle(_stageFamiliarityMeta, stageFamiliarity.isAcceptableOrUnknown(data['stage_familiarity']!, _stageFamiliarityMeta));
    }
    if (data.containsKey('next_show_time')) {
      context.handle(_nextShowTimeMeta, nextShowTime.isAcceptableOrUnknown(data['next_show_time']!, _nextShowTimeMeta));
    }
    if (data.containsKey('show_duration')) {
      context.handle(_showDurationMeta, showDuration.isAcceptableOrUnknown(data['show_duration']!, _showDurationMeta));
    }
    return context;
  }
  ...
  @override
  FragmentPermanentMemoryInfo map(Map<String, dynamic> data, {String? tablePrefix}) {
    return FragmentPermanentMemoryInfo.fromData(data, prefix: tablePrefix != null ? '$tablePrefix.' : null);
  }
...
class RFragment2FragmentGroup extends DataClass implements Insertable<RFragment2FragmentGroup> {
  ...
  factory RFragment2FragmentGroup.fromData(Map<String, dynamic> data, {String? prefix}) {
    final effectivePrefix = prefix ?? '';
    return RFragment2FragmentGroup(
      fatherId: const StringType().mapFromDatabaseResponse(data['${effectivePrefix}father_id']),
      sonId: const StringType().mapFromDatabaseResponse(data['${effectivePrefix}son_id'])!,
      id: const StringType().mapFromDatabaseResponse(data['${effectivePrefix}id'])!,
      createdAt: const DateTimeType().mapFromDatabaseResponse(data['${effectivePrefix}created_at'])!,
      updatedAt: const DateTimeType().mapFromDatabaseResponse(data['${effectivePrefix}updated_at'])!,
    );
  ...
  RFragment2FragmentGroup copyWith({String? fatherId, String? sonId, String? id, DateTime? createdAt, DateTime? updatedAt}) =>
...
class RFragment2FragmentGroupsCompanion extends UpdateCompanion<RFragment2FragmentGroup> {
  ...
  RFragment2FragmentGroupsCompanion copyWith(
      {Value<String?>? fatherId, Value<String>? sonId, Value<String>? id, Value<DateTime>? createdAt, Value<DateTime>? updatedAt}) {
    return RFragment2FragmentGroupsCompanion(
      fatherId: fatherId ?? this.fatherId,
      sonId: sonId ?? this.sonId,
      id: id ?? this.id,
...
class $RFragment2FragmentGroupsTable extends RFragment2FragmentGroups with TableInfo<$RFragment2FragmentGroupsTable, RFragment2FragmentGroup> {
  ...
  @override
  late final GeneratedColumn<String?> fatherId =
      GeneratedColumn<String?>('father_id', aliasedName, true, type: const StringType(), requiredDuringInsert: false);
  final VerificationMeta _sonIdMeta = const VerificationMeta('sonId');
  @override
  late final GeneratedColumn<String?> sonId =
      GeneratedColumn<String?>('son_id', aliasedName, false, type: const StringType(), requiredDuringInsert: true);
  final VerificationMeta _idMeta = const VerificationMeta('id');
  @override
  late final GeneratedColumn<String?> id = GeneratedColumn<String?>('id', aliasedName, false, type: const StringType(), requiredDuringInsert: true);
  final VerificationMeta _createdAtMeta = const VerificationMeta('createdAt');
  ...
  RFragment2FragmentGroup map(Map<String, dynamic> data, {String? tablePrefix}) {
    return RFragment2FragmentGroup.fromData(data, prefix: tablePrefix != null ? '$tablePrefix.' : null);
  }
...
class RFragment2MemoryGroup extends DataClass implements Insertable<RFragment2MemoryGroup> {
  ...
  factory RFragment2MemoryGroup.fromData(Map<String, dynamic> data, {String? prefix}) {
    final effectivePrefix = prefix ?? '';
  ...
  RFragment2MemoryGroup copyWith({String? fatherId, String? sonId, String? id, DateTime? createdAt, DateTime? updatedAt}) => RFragment2MemoryGroup(
        fatherId: fatherId ?? this.fatherId,
        sonId: sonId ?? this.sonId,
        id: id ?? this.id,
        createdAt: createdAt ?? this.createdAt,
...
class $RFragment2MemoryGroupsTable extends RFragment2MemoryGroups with TableInfo<$RFragment2MemoryGroupsTable, RFragment2MemoryGroup> {
  ...
  RFragment2MemoryGroup map(Map<String, dynamic> data, {String? tablePrefix}) {
    return RFragment2MemoryGroup.fromData(data, prefix: tablePrefix != null ? '$tablePrefix.' : null);
  }
...
class RMemoryModel2MemoryGroup extends DataClass implements Insertable<RMemoryModel2MemoryGroup> {
  String? fatherId;
  String sonId;
  ...
  RMemoryModel2MemoryGroup({this.fatherId, required this.sonId, required this.id, required this.createdAt, required this.updatedAt});

  factory RMemoryModel2MemoryGroup.fromData(Map<String, dynamic> data, {String? prefix}) {
    final effectivePrefix = prefix ?? '';
  ...
  factory RMemoryModel2MemoryGroup.fromJson(Map<String, dynamic> json, {ValueSerializer? serializer}) {
    serializer ??= driftRuntimeOptions.defaultSerializer;
    return RMemoryModel2MemoryGroup(
      fatherId: serializer.fromJson<String?>(json['fatherId']),
      sonId: serializer.fromJson<String>(json['sonId']),
  ...
  RMemoryModel2MemoryGroup copyWith({String? fatherId, String? sonId, String? id, DateTime? createdAt, DateTime? updatedAt}) =>
...
class RMemoryModel2MemoryGroupsCompanion extends UpdateCompanion<RMemoryModel2MemoryGroup> {
  Value<String?> fatherId;
  Value<String> sonId;
  Value<String> id;
  Value<DateTime> createdAt;
...
class $RMemoryModel2MemoryGroupsTable extends RMemoryModel2MemoryGroups with TableInfo<$RMemoryModel2MemoryGroupsTable, RMemoryModel2MemoryGroup> {
  @override
  final GeneratedDatabase attachedDatabase;
  final String? _alias;
  ...
  @override
  VerificationContext validateIntegrity(Insertable<RMemoryModel2MemoryGroup> instance, {bool isInserting = false}) {
    final context = VerificationContext();
    final data = instance.toColumns(true);
    if (data.containsKey('father_id')) {
      context.handle(_fatherIdMeta, fatherId.isAcceptableOrUnknown(data['father_id']!, _fatherIdMeta));
  ...
  @override
  RMemoryModel2MemoryGroup map(Map<String, dynamic> data, {String? tablePrefix}) {
    return RMemoryModel2MemoryGroup.fromData(data, prefix: tablePrefix != null ? '$tablePrefix.' : null);
  }
...
class RAssistedMemoryFragment2FragmentData extends DataClass implements Insertable<RAssistedMemoryFragment2FragmentData> {
  String? fatherId;
  String sonId;
  ...
  RAssistedMemoryFragment2FragmentData({this.fatherId, required this.sonId, required this.id, required this.createdAt, required this.updatedAt});

  factory RAssistedMemoryFragment2FragmentData.fromData(Map<String, dynamic> data, {String? prefix}) {
    final effectivePrefix = prefix ?? '';
  ...
  factory RAssistedMemoryFragment2FragmentData.fromJson(Map<String, dynamic> json, {ValueSerializer? serializer}) {
    serializer ??= driftRuntimeOptions.defaultSerializer;
    return RAssistedMemoryFragment2FragmentData(
      fatherId: serializer.fromJson<String?>(json['fatherId']),
      sonId: serializer.fromJson<String>(json['sonId']),
  ...
  RAssistedMemoryFragment2FragmentData copyWith({String? fatherId, String? sonId, String? id, DateTime? createdAt, DateTime? updatedAt}) =>
...
class RAssistedMemoryFragment2FragmentCompanion extends UpdateCompanion<RAssistedMemoryFragment2FragmentData> {
  Value<String?> fatherId;
  Value<String> sonId;
  Value<String> id;
  Value<DateTime> createdAt;
...
class $RAssistedMemoryFragment2FragmentTable extends RAssistedMemoryFragment2Fragment
    with TableInfo<$RAssistedMemoryFragment2FragmentTable, RAssistedMemoryFragment2FragmentData> {
  @override
  final GeneratedDatabase attachedDatabase;
  final String? _alias;
  ...
  @override
  VerificationContext validateIntegrity(Insertable<RAssistedMemoryFragment2FragmentData> instance, {bool isInserting = false}) {
    final context = VerificationContext();
    final data = instance.toColumns(true);
    if (data.containsKey('father_id')) {
      context.handle(_fatherIdMeta, fatherId.isAcceptableOrUnknown(data['father_id']!, _fatherIdMeta));
  ...
  @override
  RAssistedMemoryFragment2FragmentData map(Map<String, dynamic> data, {String? tablePrefix}) {
    return RAssistedMemoryFragment2FragmentData.fromData(data, prefix: tablePrefix != null ? '$tablePrefix.' : null);
  }
...
class AppInfo extends DataClass implements Insertable<AppInfo> {
  ...
  factory AppInfo.fromData(Map<String, dynamic> data, {String? prefix}) {
    ...
    return AppInfo(
      ...
      hasDownloadedInitData: const BoolType().mapFromDatabaseResponse(data['${effectivePrefix}has_downloaded_init_data'])!,
    );
  }
...
class AppInfosCompanion extends UpdateCompanion<AppInfo> {
  ...
  AppInfosCompanion copyWith(
      {Value<int>? id, Value<DateTime>? createdAt, Value<DateTime>? updatedAt, Value<String>? token, Value<bool>? hasDownloadedInitData}) {
    return AppInfosCompanion(
      id: id ?? this.id,
      createdAt: createdAt ?? this.createdAt,
      updatedAt: updatedAt ?? this.updatedAt,
...
class $AppInfosTable extends AppInfos with TableInfo<$AppInfosTable, AppInfo> {
  ...
  late final GeneratedColumn<String?> token = GeneratedColumn<String?>('token', aliasedName, false,
      type: const StringType(), requiredDuringInsert: false, defaultValue: const Constant('unknown'));
  ...
  VerificationContext validateIntegrity(Insertable<AppInfo> instance, {bool isInserting = false}) {
    ...
    if (data.containsKey('has_downloaded_init_data')) {
      context.handle(
          _hasDownloadedInitDataMeta, hasDownloadedInitData.isAcceptableOrUnknown(data['has_downloaded_init_data']!, _hasDownloadedInitDataMeta));
    }
    return context;
  }
  ...
  AppInfo map(Map<String, dynamic> data, {String? tablePrefix}) {
    return AppInfo.fromData(data, prefix: tablePrefix != null ? '$tablePrefix.' : null);
  }
...
class Sync extends DataClass implements Insertable<Sync> {
  ...
  factory Sync.fromData(Map<String, dynamic> data, {String? prefix}) {
    ...
    return Sync(
      ...
      createdAt: const DateTimeType().mapFromDatabaseResponse(data['${effectivePrefix}created_at'])!,
      updatedAt: const DateTimeType().mapFromDatabaseResponse(data['${effectivePrefix}updated_at'])!,
      syncTableName: const StringType().mapFromDatabaseResponse(data['${effectivePrefix}sync_table_name'])!,
      rowId: const StringType().mapFromDatabaseResponse(data['${effectivePrefix}row_id'])!,
      syncCurdType: $SyncsTable.$converter0.mapToDart(const IntType().mapFromDatabaseResponse(data['${effectivePrefix}sync_curd_type'])),
      syncUpdateColumns: const StringType().mapFromDatabaseResponse(data['${effectivePrefix}sync_update_columns']),
      tag: const IntType().mapFromDatabaseResponse(data['${effectivePrefix}tag'])!,
    );
  }
  ...
  SyncsCompanion toCompanion(bool nullToAbsent) {
    return SyncsCompanion(
      ...
      syncUpdateColumns: syncUpdateColumns == null && nullToAbsent ? const Value.absent() : Value(syncUpdateColumns),
      tag: Value(tag),
    );
  }
  ...
  factory Sync.fromJson(Map<String, dynamic> json, {ValueSerializer? serializer}) {
    ...
    return Sync(
      ...
      syncUpdateColumns: serializer.fromJson<String?>(json['syncUpdateColumns']),
  ...
  @override
  int get hashCode => Object.hash(id, createdAt, updatedAt, syncTableName, rowId, syncCurdType, syncUpdateColumns, tag);
...
class SyncsCompanion extends UpdateCompanion<Sync> {
  ...
  Map<String, Expression> toColumns(bool nullToAbsent) {
    ...
    if (syncCurdType.present) {
      final converter = $SyncsTable.$converter0;
      map['sync_curd_type'] = Variable<int?>(converter.mapToSql(syncCurdType.value));
    }
...
class $SyncsTable extends Syncs with TableInfo<$SyncsTable, Sync> {
  ...
  @override
  late final GeneratedColumn<String?> syncTableName =
      GeneratedColumn<String?>('sync_table_name', aliasedName, false, type: const StringType(), requiredDuringInsert: true);
  final VerificationMeta _rowIdMeta = const VerificationMeta('rowId');
  @override
  late final GeneratedColumn<String?> rowId =
      GeneratedColumn<String?>('row_id', aliasedName, false, type: const StringType(), requiredDuringInsert: true);
  ...
  late final GeneratedColumnWithTypeConverter<SyncCurdType?, int?> syncCurdType =
      GeneratedColumn<int?>('sync_curd_type', aliasedName, true, type: const IntType(), requiredDuringInsert: false)
          .withConverter<SyncCurdType?>($SyncsTable.$converter0);
  final VerificationMeta _syncUpdateColumnsMeta = const VerificationMeta('syncUpdateColumns');
  @override
  late final GeneratedColumn<String?> syncUpdateColumns =
      GeneratedColumn<String?>('sync_update_columns', aliasedName, true, type: const StringType(), requiredDuringInsert: false);
  final VerificationMeta _tagMeta = const VerificationMeta('tag');
  @override
  late final GeneratedColumn<int?> tag = GeneratedColumn<int?>('tag', aliasedName, false, type: const IntType(), requiredDuringInsert: true);

  @override
  List<GeneratedColumn> get $columns => [id, createdAt, updatedAt, syncTableName, rowId, syncCurdType, syncUpdateColumns, tag];
  ...
  VerificationContext validateIntegrity(Insertable<Sync> instance, {bool isInserting = false}) {
    ...
    if (data.containsKey('sync_update_columns')) {
      context.handle(_syncUpdateColumnsMeta, syncUpdateColumns.isAcceptableOrUnknown(data['sync_update_columns']!, _syncUpdateColumnsMeta));
    }
  ...
  Sync map(Map<String, dynamic> data, {String? tablePrefix}) {
    return Sync.fromData(data, prefix: tablePrefix != null ? '$tablePrefix.' : null);
  }
...
abstract class _$DriftDb extends GeneratedDatabase {
  ...
  late final $FragmentPermanentMemoryInfosTable fragmentPermanentMemoryInfos = $FragmentPermanentMemoryInfosTable(this);
  ...
  late final $RMemoryModel2MemoryGroupsTable rMemoryModel2MemoryGroups = $RMemoryModel2MemoryGroupsTable(this);
  late final $RAssistedMemoryFragment2FragmentTable rAssistedMemoryFragment2Fragment = $RAssistedMemoryFragment2FragmentTable(this);
...
mixin _$SingleDAOMixin on DatabaseAccessor<DriftDb> {
  ...
  $FragmentPermanentMemoryInfosTable get fragmentPermanentMemoryInfos => attachedDatabase.fragmentPermanentMemoryInfos;
  ...
  $RMemoryModel2MemoryGroupsTable get rMemoryModel2MemoryGroups => attachedDatabase.rMemoryModel2MemoryGroups;

  $RAssistedMemoryFragment2FragmentTable get rAssistedMemoryFragment2Fragment => attachedDatabase.rAssistedMemoryFragment2Fragment;
}
