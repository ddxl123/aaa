...
class FragmentGroupListPage extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
          ...
          SliverToBoxAdapter(
            child: g(abw).entity(abw) == null
                ...
                child: Column(
                    children: [
                Row(
                children: [Text(g(abw).entity(abw)!.title, style: Theme
                .of(context)
                .textTheme
                .titleLarge),
            // 公开/私密/发布
            IconButton(
              icon: AbwBuilder(
                builder: (abw) {
                  final bePrivate = g().entity()!.title
                      .bePrivate;
                  final bePublish = g().config()
                      .currentPerformer(abw)
                      .bePublish;
    ...
    showCreateFragmentGroupDialog(fragmentGroup: c.getCurrentGroupAb().call().entity());
    }
    },
    );
    },
